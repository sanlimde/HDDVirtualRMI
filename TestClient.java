...
public class TestClient
{
  ...
  public static void main(String[]args) throws Exception
  {
    ...
    if (args.length != 6)
      {
        System.err.
          println("Uso: TestClient hostregistro numPuertoRegistro nomFichEntradaDownload nomFichSalidaDownload nomFichEntradaUpload nomFichSalidaUpload");
        return;
      }
    ...
    HDDVirtualInterf server = (HDDVirtualInterf) Naming.lookup("//" + args[0] + ":" + args[1] + "/HDDVirtual");
    ...
    System.out.println("download: " + (len / t / 1000000 d) + " MB/s");

    t = System.currentTimeMillis();
    upload(server, new File(args[4]), new File(args[5]));
    t = (System.currentTimeMillis() - t) / 1000;
    System.out.println("upload: " + (len / t / 1000000 d) + " MB/s");
  }
